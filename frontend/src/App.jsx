...
const DEMO_PROMPTS = [
  ...
  "Ленивый робот варит кофе и постепенно просыпается",
  "Чиптюн для битвы с очень маленьким, но самоуверенным боссом",
  "Офисный принтер внезапно стал диджеем",
  "Космическая станция, где все ушли на обед",
  "Дедлайн завтра, но ты внезапно все понял",
];
